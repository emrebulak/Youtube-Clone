    ...
    return (
        <header className='flex items-center justify-between py-3 px-7'>
            ...
            <div className='w-full flex justify-center'>
                <form className='xl:w-2/5 lg:w-3/5 md:w-4/6 flex gap-3 bg-black rounded-3xl overflow-hidden border-gray-600 border-[1px]'>
                    <input className='w-full p-[8px] px-4 bg-black text-white outline-none' type="text" placeholder='Ara' />
                    <button className='px-5 bg-gray-800 hover:brightness-75 transition duration-300 border-l-[1px] border-gray-600' type='button'><IoSearchOutline className='size-5'/></button>
                </form>
            </div>
